...
favoriteFoods.push('brussel sprouts');
console.log('Remembered and added another favorite food', favoriteFoods);
...
let brusselSprouts = favoriteFoods.pop();
console.log('Just remembered my childhood training that no one likes', brusselSprouts);
console.log('My list of favoriteFoods is again', favoriteFoods);
...
console.log(`Added the king of all foods to the beginning of the list: ${favoriteFoods}`);
